...
class BaseDataset(Dataset):
    ...
    def __init__(self,
        ...
        self.im_files = self.get_img_files(self.img_path + '/night')
        self.im_files2 = self.get_img_files(self.img_path + '/thermal')
    ...
    def get_label_info(self, index):
        ...
        label['img'], label['img2'], label['ori_shape'], label['resized_shape'] = self.load_image(index)
        label['ratio_pad'] = (
